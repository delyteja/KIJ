...
@section('action-content')
		<section class="content-header">
                <h1 style="text-align: center;"><b> Menambah Nama Kategori Pemasukan</b></h1>
            </section>
            <div class="panel-body">
                <div class="panel panel-default" style="margin-bottom:290px;margin-top:75px;">
                    <div class="panel-body">
                        <form method="POST" action="{{ url('/tambah_kategori/store_nama_kategori_pemasukan')}}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
