...
<!-- 'user_id', 'date_created', 'time_created','nama_transaksi','jumlah','kategori_id','nama_bukti','lokasi',
 -->		<section class="content-header">
                <h1 style="text-align: center;"><b>Pengeluaran</b></h1>
            </section>
            <div class="panel-body">
                <div class="panel panel-default" style="margin-bottom:290px;margin-top:75px;">
                    <div class="panel-body">
                        <form method="POST" action="{{ url('/pengeluaran/store')}}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
